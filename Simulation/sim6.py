...
training, test = get_data('SimData/train6.csv', 'SimData/test6.csv')
...
np.savetxt("SimData/mean6.csv", mean, delimiter=",")
...
np.savetxt("SimData/sim6va.csv", va_features, delimiter=",")

raw_mixing = np.array(raw_transformer.components_)
np.savetxt("SimData/sim6raw.csv", raw_features, delimiter=",")