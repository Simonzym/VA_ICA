...
training, test = get_data('SimData/train33.csv', 'SimData/test33.csv')
...
np.savetxt("SimData/mean33.csv", mean, delimiter=",")
...
np.savetxt("SimData/sim33va.csv", va_features, delimiter=",")

raw_mixing = np.array(raw_transformer.components_)
np.savetxt("SimData/sim33raw.csv", raw_features, delimiter=",")