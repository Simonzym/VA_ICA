...
training, test = get_data('SimData/train1.csv', 'SimData/test1.csv')
...
np.savetxt("SimData/mean1.csv", mean, delimiter=",")
...
np.savetxt("SimData/sim1va.csv", va_features, delimiter=",")

raw_mixing = np.array(raw_transformer.components_)
np.savetxt("SimData/sim1raw.csv", raw_features, delimiter=",")

#save the estimated mixing matrix
# va_mixing = np.array(va_transformer.components_)
# np.savetxt("sim1va.csv", va_mixing, delimiter=",")

# raw_mixing = np.array(raw_transformer.components_)
# np.savetxt("sim1raw.csv", raw_mixing, delimiter=",")
