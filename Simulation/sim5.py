...
training, test = get_data('SimData/train5.csv', 'SimData/test5.csv')
...
np.savetxt("SimData/mean31.csv", mean, delimiter=",")
...
np.savetxt("SimData/sim31va.csv", va_features, delimiter=",")

raw_mixing = np.array(raw_transformer.components_)
np.savetxt("SimData/sim31raw.csv", raw_features, delimiter=",")