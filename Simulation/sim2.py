...
training, test = get_data('SimData/train2.csv', 'SimData/test2.csv')
...
np.savetxt("SimData/mean2.csv", mean, delimiter=",")
...
np.savetxt("SimData/sim2va.csv", va_features, delimiter=",")

raw_mixing = np.array(raw_transformer.components_)
np.savetxt("SimData/sim2raw.csv", raw_features, delimiter=",")

#save the estimated mixing matrix
# va_mixing = np.array(va_transformer.components_)
# np.savetxt("sim2va.csv", va_mixing, delimiter=",")

# raw_mixing = np.array(raw_transformer.components_)
# np.savetxt("sim2raw.csv", raw_mixing, delimiter=",")
